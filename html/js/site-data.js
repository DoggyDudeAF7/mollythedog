(function () {
  ...
  const pages = [
    ...
    ["page:dog-diaries", "Dog Diaries", "Imagined diary entries from Molly, Shaina, and Poppy, inspired by their real personalities and habits.", "Page", "📓", "/dog-diaries/", "diary stories molly shaina poppy journal"],
    ["page:about", "Meet the Creator", "Meet Asher, the coder and musician behind the Molly and Shaina website.", "Page", ":about:", "/about-me/", "creator human asher"],
    ...
    ["page:images", "Images", "Browse new Molly, Shaina, and Poppy wallpapers, phone crops, colouring pages, and bookmarks.", "Gallery", ":gallery:", "/images/", "pictures downloads wallpapers printables colouring bookmarks"],
