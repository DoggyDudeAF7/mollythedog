document.addEventListener("DOMContentLoaded", () => {
  ...
  const commands = shainaSite ? [
    ...
    { key: "zoom comic", action: () => location.href = "../comic-viewer/?q=zoom" },
    { key: "zoom meeting", action: () => location.href = "../comic-viewer/?q=zoom" },
    { key: "submit", action: () => location.href = "../submit/" },
    { key: "submit idea", action: () => location.href = "../submit/" },
    { key: "fan art", action: () => location.href = "../submit/" },
    { key: "freebie den", action: () => location.href = "../freebie-den/" },
    { key: "wallpapers", action: () => location.href = "../freebie-den/" },
    { key: "downloads", action: () => location.href = "../freebie-den/" },
    { key: "about", action: () => location.href = "../about-me/" },
    { key: "about me", action: () => location.href = "../about-me/" },
    { key: "about molly", action: () => location.href = "../about-molly/" },
    { key: "molly book", action: () => location.href = "../about-molly/" },
    { key: "about shaina", action: () => location.href = "../about-shaina/" },
    { key: "shaina book", action: () => location.href = "../about-shaina/" },
